<script lang="ts">
	...
	interface Props {
		...
		// import runs. Only the browser import flow reports progress.
	...
	// Desktop exposes a native directory picker; the web app falls back to
	// importing a dropped/picked folder into its virtual filesystem.
	const hasNativePicker = !!platformHooks()?.pickDirectory;
