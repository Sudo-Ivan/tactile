// Package identity provides the relay identity model: an Ed25519 public key
// is the identity, and the identity ID is the SHA-256 of that key, adapted
// from Reticulum's model where a destination is just a key hash.
package identity
...
// Sybil identity creation without accounts.
