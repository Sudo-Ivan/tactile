<script lang="ts">
	...
	import { APP_URL, ICON_COLOR, RELEASES_URL } from '$lib/site';
...
>
	...
	>
		<PlatformButton
			...
			active={selected === 'mac'}
		>
			<svg xmlns="http://www.w3.org/2000/svg" fill={ICON_COLOR} viewBox="0 0 24 24" class="h-6 w-6">
				<path
		...
		>
			<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill={ICON_COLOR} class="h-6 w-6">
				<path
		...
		<PlatformButton
			...
			active={selected === 'web'}
		>
			<Globe class="h-6 w-6" style="color: {ICON_COLOR}" />
		</PlatformButton>
		<PlatformButton
		...
		>
			<Smartphone class="h-6 w-6" style="color: {ICON_COLOR}" />
		</PlatformButton>
	</div>
