<script lang="ts">
	...
	import { DAILY_DIR, MARKDOWN_EXTENSION, SHORTCUTS } from '@/constants';
...
<div
	class={cn(
		'relative flex flex-col w-full h-full items-start bg-secondary-background overflow-y-auto',
